...
//  voice-pick-frontend
//
//  Created by Håkon Sætre on 10/02/2023.
//
...
extension Font {
		static let header1 = Font.custom("Roboto-Bold", size: 34)
		static let header2 = Font.custom("Roboto-Bold", size: 20)
		static let customBody = Font.custom("Roboto-Regular", size: 16)
		static let guidelineHeading = Font.custom("Roboto-Bold", size: 70)
